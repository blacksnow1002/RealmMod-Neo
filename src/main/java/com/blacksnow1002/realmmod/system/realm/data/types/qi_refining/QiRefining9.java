...
public class QiRefining9 extends BaseRealm {

    public static final QiRefining9 INSTANCE = new QiRefining9();

    private QiRefining9() {
        super(
                RealmRegistry.RealmIds.QI_REFINING_9,
                "練氣九層",
                9,
                CultivationRealm.QI_REFINING,
                9,
                QiRefiningPerfect.INSTANCE
        );
    }

...
public class QiRefining6 extends BaseRealm {

    public static final QiRefining6 INSTANCE = new QiRefining6();

    private QiRefining6() {
        super(
                RealmRegistry.RealmIds.QI_REFINING_6,
                "練氣六層",
                6,
                CultivationRealm.QI_REFINING,
                6,
                QiRefining7.INSTANCE
        );
    }

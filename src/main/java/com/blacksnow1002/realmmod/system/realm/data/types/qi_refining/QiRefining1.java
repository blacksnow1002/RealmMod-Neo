...
public class QiRefining1 extends BaseRealm {

    public static final QiRefining1 INSTANCE = new QiRefining1();

    private QiRefining1() {
        super(
                RealmRegistry.RealmIds.QI_REFINING_1,
                "練氣一層",
                1,
                CultivationRealm.QI_REFINING,
                1,
                QiRefining2.INSTANCE
        );
    }

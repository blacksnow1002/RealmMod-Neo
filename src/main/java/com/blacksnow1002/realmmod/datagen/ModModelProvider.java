...
public class ModModelProvider extends ModelProvider {
    public ModModelProvider(PackOutput output) {
        super(output, RealmMod.MOD_ID);
    }

    @Override
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        itemModels.generateFlatItem(ModItems.SPIRIT_FRUIT.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ModItems.SPIRIT_STONE_LOW.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ModItems.SPIRIT_STONE_MIDDLE.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ModItems.SPIRIT_STONE_HIGH.get(), ModelTemplates.FLAT_ITEM);
